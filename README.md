...
| [SPFx React Controls](https://reactcontrols.spteckapps.com) | Community-driven reusable React controls for SharePoint Framework solutions, created by [João Mendes](https://www.linkedin.com/in/joaojosemendes/) (v2.5.7) | Community |
...
| [LookBook 365](https://lookbook365.com/#categories) | A large collection of SharePoint Online site design templates organized by category, created by [SharePoint Maven](https://www.linkedin.com/in/gregoryzelfond/) | Free |

### YouTube Channels
SharePoint and Microsoft 365 YouTube channels for tutorials, tips, and demos.

| Resource | Description |
| :--- | :--- |
| [SharePoint Maven](https://www.youtube.com/@SharePointMaven/videos) | Tutorials on SharePoint, OneDrive, Teams, and Microsoft 365 by Greg Zelfond — a U.S.-based SharePoint consultant focused on 100% out-of-the-box solutions, no custom code or third-party add-ons |
| [Microsoft Community Learning](https://www.youtube.com/@MicrosoftCommunityLearning) | Official Microsoft channel with weekly webcasts, demos, tutorials, and best practices for Copilot, Microsoft 365, Power Platform, and Viva — created by Microsoft together with MVPs for developers, IT pros, and beginners |
| [SPGuides (Bijay Kumar)](https://www.youtube.com/@SPGuides/videos) | Master SharePoint, Power Platform, SPFx, and Microsoft 365 with Bijay Kumar — a Microsoft MVP with 12+ years of recognition and 18+ years of hands-on experience covering Power Apps, Power Automate, Power BI, Copilot Studio, Teams, and PowerShell |
| [Steve Corey](https://www.youtube.com/@stevecorey365/videos) | Practical tutorials by a Microsoft MVP helping M365 professionals and business users build Copilot agents that actually work — complex concepts broken down into simple, actionable steps |
| [Codeman](https://www.youtube.com/@codeman5277/videos) | Hands-on walkthroughs for SharePoint, Power Apps, and Microsoft 365 development by Siddharth Vaghasia |
| [Daniel Anderson](https://www.youtube.com/@DanielAndersonAU/videos) | Microsoft 365 and SharePoint tutorials with a focus on modern workplace solutions |
| [Paul Keijzers \| KbWorks](https://www.youtube.com/@kbworks_eu/videos) | Tutorials, analyses, and strategies for SharePoint, Teams, Copilot, and Microsoft 365 by Microsoft MVP Paul Keijzers — helping businesses integrate M365 technologies effectively |
| [Academy 365 - Dan](https://www.youtube.com/@Academy365-Dan/videos) | "How-to" videos packed with tips, tricks, and best practices for SharePoint Online, Teams, Forms, Planner, Lists, and other Microsoft 365 apps |
| [Giulian De Luca](https://www.youtube.com/@DeLucaGiulian/videos) | How-to tutorials for developers, IT pros, and end users covering Microsoft 365, Azure, and cloud tools by a Microsoft MVP for Microsoft 365 |
| [Dougie Wood](https://www.youtube.com/@Dougie_Wood/videos) | Expert SharePoint design and intranet-building tutorials by a Microsoft MVP and ESPC Awards nominee — covering site building, modern intranet design, web parts, permissions, and governance |
...
2. Add an entry with `title`, `description`, `url`, and `tag`:
   - `Official` — published by Microsoft
   - `Community` — built by the SharePoint/Microsoft 365 community
   - `Free` — created by an individual and free to use (include creator credit in the description)
